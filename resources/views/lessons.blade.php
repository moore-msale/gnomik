...
@section('content')
    ...
    <div class="container-fluid pt-3" id="courses">
        <div class="row p-lg-5 p-md-5 p-3">
            <p class="text-fut-bold ml-lg-3 mr-lg-3 pl-lg-4 pr-lg-4 text-md-left text-center" style="font-size: 22px;line-height: 28px;color: #000000;">В частном детском саду “ГНОМИК” проводятся следующие учебно-воспитательные занятия:</p>
        </div>
        <div class="row">
            <div class="container-fluid">
                ...
                <div class="row p-lg-5">
                    <p class="text-fut-bold ml-3 mr-3 pl-4 pr-4 pt-md-0 pt-4" style="font-size: 22px;line-height: 28px;color: #000000;">Дополнительные услуги: детского сада “ ГНОМИК ”</p>
