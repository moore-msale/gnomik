...
@section('content')
    ...
    <div class="container-fluid pt-3" id="courses">
        <div class="row p-5">
            <p class="text-fut-bold ml-3 mr-3 pl-4 pr-4" style="font-size: 22px;line-height: 28px;color: #000000;">В частном детском саду “ ГНОМИК ” проводятся следующие учебно-воспитательные занятия:</p>
        </div>
        <div class="row">
